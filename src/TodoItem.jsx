		...
		<li key={props.todo.text} className={props.todo.completed ? 'todo-item completed' : props.todo.editing ? 'todo-item is-editing' : 'todo-item'}>
			...
			{props.todo.completed ? (
				<div className="tooltip-wrapper">
					...
					<div className="tooltip mark-uncompleted">
				...
				<div className="tooltip-wrapper">
					...
					<div className="tooltip mark-complete">
			...
			{props.todo.editing ? (
				<form onSubmit={props.handleSaveTodo} className="edit-form">
					...
					<div className="tooltip-wrapper">
						<button type="submit" className="no-fill-icon-button">
							<svg width="12" height="12" viewBox="0 0 24 24">
								<path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
							</svg>
						</button>
			...
			<div className="right">
				...
				{props.todo.important ?
					<div className="tooltip-wrapper">
						<button className="no-fill-icon-button star-button" onClick={() => props.handleMarkImportant()}>
					...
					<div className="tooltip-wrapper">
						...
						<button className="no-fill-icon-button star-button" onClick={() => props.handleMarkImportant()}>
							<svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512"><title>Star</title><path d="M480 208H308L256 48l-52 160H32l140 96-54 160 138-100 138 100-54-160z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="32" />
							</svg>
						</button>
				...
				<div className="dropdown">
					<div className="tooltip-wrapper">
						<button className="no-fill-icon-button" onClick={() => setDropdownOpen(!dropdownOpen)}>
							<svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512"><title>Ellipsis Horizontal</title><circle cx="256" cy="256" r="48" /><circle cx="416" cy="256" r="48" /><circle cx="96" cy="256" r="48" />
							</svg>
						</button>
						<div className="tooltip more-options">
					...
					<div className={`dropdown-content ${dropdownOpen ? "show" : ""} ${props.todo.important ? "important" : ""}`}>
						...
						<button tabIndex={`${dropdownOpen ? "0" : "-1"}`} onClick={() => {
							...
							{props.todo.completed ? (
								<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512" fill="none" className="no-fill-svg">
									<path d="M448 256C448 150 362 64 256 64C150 64 64 150 64 256C64 362 150 448 256 448C362 448 448 362 448 256Z" stroke="black" strokeWidth="32" strokeMiterlimit="10" />
								</svg>
							) : (
						...
						<button tabIndex={`${dropdownOpen ? "0" : "-1"}`} onClick={() => {
							...
							{props.todo.important ?
								<>
									<svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512"><title>Star</title><path d="M394 480a16 16 0 01-9.39-3L256 383.76 127.39 477a16 16 0 01-24.55-18.08L153 310.35 23 221.2a16 16 0 019-29.2h160.38l48.4-148.95a16 16 0 0130.44 0l48.4 149H480a16 16 0 019.05 29.2L359 310.35l50.13 148.53A16 16 0 01394 480z" /></svg>
